...
import com.minatoorgtestcase.taskurltest.base.model.constants.TaskUrlTestTable1ConstantBase;
...
@Component
public abstract class TaskUrlTestTable1PerimeterBaseImpl<T extends TaskUrlTestTable1Base> implements IPerimeterManager<T>, TaskUrlTestTable1ConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(TaskUrlTestTable1PerimeterBaseImpl.class);
