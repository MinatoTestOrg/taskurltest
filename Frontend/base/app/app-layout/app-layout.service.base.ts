...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"element":"logo"},{"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"element":"appTitle"}],"middle":[{"element":"leftPane"},{"element":"middlePane"},{"element":"rightPane"}],"right":[{"menuType":"float","element":"rightMenu"},{"children":[{"element":"logout"}],"element":"user"},{"menuType":"float","element":"navigationTabs"}]};
