package com.minatoorgtestcase.taskurltest;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatoorgtestcase.taskurltest"})
@EnableCaching
...
public class TaskurltestApplication {

	public static void main(String[] args) {
		SpringApplication.run(TaskurltestApplication.class, args);
	}
